...
export default function Navbar() {
  ...
  return (
    ...
    <>
    <nav id="nav" className={`bg-white fixed top-0 inset-x-0 font-poppins text-black md:h-[5rem] h-[8rem] md:py-0 py-10  transition duration-500 z-50 md:overflow-y-visible overflow-y-hidden md:flex items-center md:drop-shadow-lg `}>
      <div className="w-full pl-[5.8rem] pr-[7.7rem] md:pl-[7.4rem] md:pr-[6.4rem] ">
        <div className="w-full flex justify-between items-center">
          ...
          <div className=" hidden md:row-y-center space-x-[1rem] text-xs w-[48%] ">
            ...
            <a href="#" className="hover:text-blue-400 transition">Components</a>
            <a href="#" className="hover:text-blue-400 transition row-y-center gap-1 py-5 " onMouseEnter={() => setDropMenus(true)} onMouseLeave={() => setDropMenus(false)} ><span>Example Pages</span> 
           ...
           >
            ...
            <div className="social-links flex space-x-[0.4rem]">
              <a href=""><i className="fab fa-facebook-square text-[1.2rem] "></i></a>
              <a href=""><i className="fab fa-twitter-square text-[1.2rem] "></i></a>
              <a href=""><i className="fab fa-instagram text-[1.2rem] "></i></a>
            </div>
 ...
 {/* Mobile Menu (hidden by default) */}    
      <div id="mobile-menu" className={` bg-white drop-shadow-lg absolute top-0 inset-x-0  md:hidden overflow-hidden px-2 pb-8 pt-24  space-y-[4.3rem] text-2xl transition-all duration-500 ease-linear ${mobileMenuOpen?' max-h-[90rem] ': 'max-h-0 '}`}>
            <a href="#" className="hover:text-gray-500 transition block mx-auto w-fit mt-10">Docs</a>
          ...
          <div className={`block mx-auto w-[20rem] -translate-y-[2.1rem] bg-white shadow-2xl rounded-md py-5 
           ${dropMenus? 'block translate-y-0 duration-300 ' : 'hidden translate-y-4 pointer-events-none '} transition-all 
           `}
           >
             <a href="#" className='block px-10 py-5 hover:bg-gray-100 rounded' role='menuitem'>About</a>
             <a href="#" className='block px-10 py-5 hover:bg-gray-100 rounded' role='menuitem'>Login Page </a>
             <a href="#" className='block px-10 py-5 hover:bg-gray-100 rounded' role='menuitem'>Testimonials </a>
             <a href="#" className='block px-10 py-5 hover:bg-gray-100 rounded' role='menuitem'>Pricing</a>
             <a href="#" className='block px-10 py-5 hover:bg-gray-100 rounded' role='menuitem'>Products</a>
             <a href="#" className='block px-10 py-5 hover:bg-gray-100 rounded' role='menuitem'>Profile Page </a>
             <a href="#" className='block px-10 py-5 hover:bg-gray-100 rounded' role='menuitem'>Register</a>
             <a href="#" className='block px-10 py-5 hover:bg-gray-100 rounded' role='menuitem'>Login Page</a>
             <a href="#" className='block px-10 py-5 hover:bg-gray-100 rounded' role='menuitem'>Blog Archive</a>
             <a href="#" className='block px-10 py-5 hover:bg-gray-100 rounded' role='menuitem'>Blog Post</a>
             <a href="#" className='block px-10 py-5 hover:bg-gray-100 rounded' role='menuitem'>Contact </a>
           </div>

            <div className="social-links -translate-y-4 center space-x-7 ">
              <a href=""><i className="fab fa-facebook-square text-[2.5rem] "></i></a>
              <a href=""><i className="fab fa-twitter-square text-[2.5rem] "></i></a>
              <a href=""><i className="fab fa-instagram text-[2.5rem]"></i></a>
