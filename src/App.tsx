...
function App() {
  ...
  return (
    ...
    <ErrorBoundary>
      <div className="w-screen min-h-screen  bg-gray-200 dark:bg-gray-950 text-gray-900 dark:text-gray-100">
        ...
        <main className=" max-w-7xl mx-auto md:px-10 px-20 py-8">
          ...
          <section className="mb-20">
            <div className=' mb-8 flex items-center lg:gap-2 sm:gap-6 gap-8 '>
              {/* Mission icon */}
              <svg className='w-fit lg:size-6 sm:size-12 size-16 stroke-black dark:stroke-gray-50' version="1.1" id="Icons" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
          ...
          <section className="mb-20">
            <div className=' mb-8 flex items-center lg:gap-2 sm:gap-6 gap-8'>
              {/* Users Icon */}
              <svg className='w-fit! lg:size-6 sm:size-12 size-16 stroke-black dark:stroke-gray-50' fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <section className="mb-20">
            <div className='mb-8 flex items-center lg:gap-2 sm:gap-6 gap-8'>
              ...
              {/* Image icon */}
              <svg className='w-fit lg:size-6 sm:size-12 size-16 stroke-black dark:stroke-gray-50' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4.02693 18.329C4.18385 19.277 5.0075 20 6 20H18C19.1046 20 20 19.1046 20 18V14.1901M4.02693 18.329C4.00922 18.222 4 18.1121 4 18V6C4 4.89543 4.89543 4 6 4H18C19.1046 4 20 4.89543 20 6V14.1901M4.02693 18.329L7.84762 14.5083C8.52765 13.9133 9.52219 13.8482 10.274 14.3494L10.7832 14.6888C11.5078 15.1719 12.4619 15.1305 13.142 14.5865L15.7901 12.4679C16.4651 11.9279 17.4053 11.8856 18.1228 12.3484C18.2023 12.3997 18.2731 12.4632 18.34 12.5302L20 14.1901M11 9C11 10.1046 10.1046 11 9 11C7.89543 11 7 10.1046 7 9C7 7.89543 7.89543 7 9 7C10.1046 7 11 7.89543 11 9Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
          ...
          <section className="mb-20">
            <div className='mb-8 flex items-center lg:gap-2 sm:gap-6 gap-8'>
              {/* Promodo icon */}
              <svg className='w-fit lg:size-6 sm:size-12 size-16  dark:stroke-gray-50' viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 13h4v1h-5V7h1zM9 2h6V1H9zm13.65 3.916l-2.176 2.177A9.8 9.8 0 1 1 17.6 4.965l2.049-2.049zM12 4.2a8.8 8.8 0 1 0 8.8 8.8A8.81 8.81 0 0 0 12 4.2zm9.236 1.716L19.65 4.33l-1.086 1.086 1.586 1.586z" /><path fill="none" d="M0 0h24v24H0z" /></svg>
              <h2 className="w-fit lg:text-2xl sm:text-5xl text-7xl font-bold tracking-tight">Contact Form</h2>
            </div>
            <ContactForm />
          </section>
